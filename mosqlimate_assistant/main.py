from mosqlimate_assistant import assistant, faiss_db
...
def assistant_pipeline(
    ...
    relevant_samples, scores = faiss_db.get_relevant_sample_asks(
        question, k=k_num
    )
    ...
    relevant_docs, docs_scores = faiss_db.get_relevant_docs(question, k=k_num)
