from mosqlimate_assistant.models import (
    ProviderType, ChatMessage, ProviderResponse, 
    VectorDocument, VectorSearchResult, SourceDocument
)
...
def test_source_document():
    doc = SourceDocument(content="test", source_type="csv", source_identifier="file.csv")
    assert doc.content == "test"
